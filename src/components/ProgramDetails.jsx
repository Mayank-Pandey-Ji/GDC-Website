    ...
    <section className="py-12 px-4 sm:px-6 lg:px-8 bg-[#09101a]">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-[#ccb2fb] mb-4">Program details</h1>
        ...
        <div className="bg-gradient-to-br from-[#0f1722] to-[#02050a] p-8 rounded-2xl shadow-2xl border border-[#55e6a5] mb-12">
          <h2 className="text-2xl font-bold text-[#ccb2fb] mb-8">What you'll get</h2>
        ...
        <div className="bg-gradient-to-br from-[#0f1722] to-[#02050a] p-8 rounded-2xl shadow-2xl border border-[#55e6a5] mb-12">
          <h3 className="text-xl font-semibold text-[#ccb2fb] mb-6">Interested?</h3>
        ...
        <div className="text-center">
          {/* <button className="bg-gradient-to-r from-[#55e6a5] to-green-600 hover:from-green-600 hover:to-[#55e6a5] text-[#0a0217] font-bold py-4 px-10 rounded-xl text-lg transition-all hover:scale-105 shadow-lg border border-[#55e6a5] mb-6">
            Apply now
          </button> */}
          <p className="text-gray-300 leading-relaxed">
            Please take moment to answer the questions; we use these to assess whether you're a good fit!
          </p>
        </div>
      </div>
    </section>
