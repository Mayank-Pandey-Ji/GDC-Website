    ...
    <section className="py-16 px-6 sm:px-8 lg:px-12 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-indigo-700 mb-4">Program details</h1>
        ...
        {/* Benefits Card */}
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-indigo-100 mb-12">
          <h2 className="text-2xl font-bold text-indigo-700 mb-8">What you'll get</h2>
          <ul className="space-y-6">
            {benefits.map((benefit, index) => (
              <li key={index} className="flex items-start">
                <div className="flex-shrink-0 w-7 h-7 rounded-full bg-green-500 flex items-center justify-center mr-4 mt-0.5 shadow-md">
        ...
        {/* Interested Card */}
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-indigo-100 mb-12">
          <h3 className="text-xl font-semibold text-indigo-700 mb-6">Interested?</h3>
