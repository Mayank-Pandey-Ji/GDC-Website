    ...
    <section className="py-16 px-6 sm:px-8 lg:px-12 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-[#0f1e25] mb-4">Program details</h1>
        ...
        {/* Benefits Card */}
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-cyan-400 mb-12">
          <h2 className="text-2xl font-bold text-[#0f1e25] mb-8">What you'll get</h2>
          <ul className="space-y-6">
            {benefits.map((benefit, index) => (
              <li key={index} className="flex items-start">
                ...
                <span className="text-gray-400 leading-relaxed">{benefit}</span>
              </li>
            ))}
          </ul>
        </div>
        ...
        {/* Interested Card */}
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-cyan-400 mb-12">
          <h3 className="text-xl font-semibold text-[#0f1e25] mb-6">Interested?</h3>
