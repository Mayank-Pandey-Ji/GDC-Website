      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
            {videos.slice(currentSlide, currentSlide + 3).concat(
              ...
              <div key={`${currentSlide}-${index}`} className="group cursor-pointer">
                <div className="bg-[#181f28] rounded-2xl overflow-hidden aspect-video relative border border-cyan-400 shadow-md hover:shadow-xl transition-all hover:scale-105">
                  ...
                  {/* Duration Badge */}
                  <div className="absolute bottom-4 right-4 bg-cyan-400 px-2 py-1 rounded text-[#0f1e25] text-sm shadow-sm">
                    {video.duration}
                  </div>
                </div>
                
                <div className="mt-4">
                  <p className="text-cyan-400 font-medium text-center">{video.title}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="flex justify-center items-center space-x-4">
            <button 
              onClick={prevSlide}
              className="w-12 h-12 bg-gradient-to-r from-cyan-400 to-cyan-600 hover:from-cyan-300 hover:to-cyan-400 text-white rounded-full flex items-center justify-center transition-all hover:scale-110 shadow-md"
            >
          ...
          <div className="text-center mt-12">
            ...
            <button className="bg-gradient-to-r from-cyan-400 to-cyan-600 hover:from-cyan-300 hover:to-cyan-400 text-white font-bold py-4 px-10 rounded-xl text-lg transition-all hover:scale-105 shadow-lg">
