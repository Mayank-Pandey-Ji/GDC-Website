...
const OnlineCohort = () => {
  return (
    <>
      ...
      <section
        id="mentors"
        className="bg-[#0c1a21] border-t border-cyan-900/50"
      >
        <div className="w-full text-white py-16 flex flex-col items-center justify-center text-center gap-y-6 px-4">
          ...
          <p className="text-base md:text-lg text-sky-400">
            Learn from the best
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#0c1a21] text-white py-16 px-4 border-t border-cyan-900/50">
        <div className="flex flex-col items-center justify-center text-center w-full gap-y-8">
          ...
          <p className="font-medium text-lg text-cyan-300 max-w-4xl leading-relaxed">
            ...
            manner. These objectives translate GDC's broader values and
            ambitions into concrete, measurable, and time-bound goals that
            support long-term impact and operational success. Each objective
            below is mapped to a strategic function of the organization,
            ensuring that GDC evolves as a results-oriented, adaptive, and
